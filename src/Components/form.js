...
const FormCom = ({ handleCancel }) => {
  const [BankingDetails, setBankingdetailsContext] = useContext(
    BankingdetailsContext
  );
  ...
  const onFinish = (values) => {
    ...
    axios({
      ...
      .then((response) => {
        ...
        const index = BankingDetails.length;
        const dataobj = {
          key: index,
  ...
  return (
    <>
      ...
      >
        ...
        <Form.Item name="bankAddress" label="Bank Address" rules={[
            {
              required: true,
            },
          ]}>
        ...
        <Form.Item name="DOP" label="Opening Date" rules={[
            {
              required: true,
            },
          ]}>
